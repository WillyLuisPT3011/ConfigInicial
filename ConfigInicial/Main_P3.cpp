...
int main() {
	...
	GLFWwindow *window = glfwCreateWindow(WIDTH, HEIGHT, "Practica 3 Transformaciones_JoseLuis_Arroyo", nullptr, nullptr);
 ...
 //     
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		// ---- Cubo 2 (Base derecha) ----
		model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(3.5f, 0.0f, -6.0f));
		model = glm::rotate(model, 2.0f, glm::vec3(1.5f, 2.0f, 0.5f)); // use to compare orthographic and perspective projection
		model = glm::scale(model, glm::vec3(2.0f, 2.0f, 2.0f));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glDrawArrays(GL_TRIANGLES, 0, 36);
		// ---- Cubo 2 (Base izquierda) ----
		model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(-3.5f, 0.0f, -6.0f));
		model = glm::rotate(model, -2.0f, glm::vec3(-3.0f, 2.0f, -6.0f)); // use to compare orthographic and perspective projection
		model = glm::scale(model, glm::vec3(2.0f, 2.0f, 2.0f));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glDrawArrays(GL_TRIANGLES, 0, 36);
		// ---- Cubo 3 (Punta) ----
		model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(0.0f, 3.5f, -6.0f));
		model = glm::rotate(model, -2.0f, glm::vec3(5.0f, 3.5f, 2.5f)); // use to compare orthographic and perspective projection
		model = glm::scale(model, glm::vec3(2.0f, 2.0f, 2.0f));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glDrawArrays(GL_TRIANGLES, 0, 36);
		glBindVertexArray(0);
